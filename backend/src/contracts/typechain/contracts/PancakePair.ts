...
export interface PancakePairInterface extends utils.Interface {
  functions: {
    ...
    "isDeactivated()": FunctionFragment;
...
export interface PancakePair extends BaseContract {
  ...
  functions: {
    ...
    isDeactivated(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isDeactivated(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isDeactivated(overrides?: CallOverrides): Promise<PopulatedTransaction>;
