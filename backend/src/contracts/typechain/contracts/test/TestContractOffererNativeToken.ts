...
export interface TestContractOffererNativeTokenInterface
...
export interface TestContractOffererNativeToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestContractOffererNativeTokenInterface;
