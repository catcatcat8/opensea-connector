...
export interface TestInvalidContractOffererInterface extends utils.Interface {
  functions: {
...
export interface TestInvalidContractOfferer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestInvalidContractOffererInterface;
  ...
  functions: {
    ...
    ): Promise<[SpentItemStructOutput[], ReceivedItemStructOutput[]]>;
