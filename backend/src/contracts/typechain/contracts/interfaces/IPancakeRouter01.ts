...
export interface IPancakeRouter01Interface extends utils.Interface {
  functions: {
    ...
    "getAmountsIn(uint256,address[],bool)": FunctionFragment;
    ...
    "swapETHForExactTokens(uint256,address[],address,uint256,bool)": FunctionFragment;
    ...
    "swapTokensForExactETH(uint256,uint256,address[],address,uint256,bool)": FunctionFragment;
