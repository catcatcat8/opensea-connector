...
export declare namespace PancakeZapV1 {
  export type ZapTokenRebalancingStruct = {
  ...
  export type ZapTokenRebalancingStructOutput = [
    string,
    string,
    BigNumber,
    BigNumber,
    ...
    _token0ToZap: string;
    _token1ToZap: string;
    _token0AmountIn: BigNumber;
    _token1AmountIn: BigNumber;
    _lpToken: string;
    _tokenAmountInMax: BigNumber;
    _tokenAmountOutMin: BigNumber;
...
export interface PancakeZapV1Interface extends utils.Interface {
  functions: {
    ...
    "estimateZapInRebalancingSwap(address,address,uint256,uint256,address,bool)": FunctionFragment;
    "estimateZapInSwap(address,uint256,address,bool)": FunctionFragment;
    "estimateZapOutSwap(address,uint256,address,bool)": FunctionFragment;
    ...
    "zapInBNB(address,uint256,bool)": FunctionFragment;
    "zapInBNBRebalancing(address,uint256,address,uint256,uint256,bool,bool)": FunctionFragment;
    "zapInToken(address,uint256,address,uint256,bool)": FunctionFragment;
    "zapInTokenRebalancing((address,address,uint256,uint256,address,uint256,uint256,bool,bool))": FunctionFragment;
    "zapOutBNB(address,uint256,uint256,uint256,bool)": FunctionFragment;
    "zapOutToken(address,address,uint256,uint256,uint256,bool)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [PancakeZapV1.ZapTokenRebalancingStruct]
  ): string;
  encodeFunctionData(
...
export interface PancakeZapV1 extends BaseContract {
  ...
  functions: {
    ...
    zapInTokenRebalancing(
      _zapTokenRebalancing: PancakeZapV1.ZapTokenRebalancingStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    zapOutBNB(
      ...
      _lpTokenAmount: PromiseOrValue<BigNumberish>,
      _tokenAmountOutMin: PromiseOrValue<BigNumberish>,
      _totalTokenAmountOutMin: PromiseOrValue<BigNumberish>,
      isFeeEnabled: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
